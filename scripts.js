...
let noticias = [
  {
    'url': "./imagenes/tiger.jpg",
    'titulo': "El tigre",
    'descripcion': `El tigre (Panthera tigris) es una de las especies​ de la subfamilia de los panterinos (familia Felidae)
  ...
  },
  {
    ...
    'titulo': "El leon",
    'descripcion': `El león (Panthera leo) es un mamífero carnívoro de la familia de los félidos y una de las cinco especies del
  ...
  },
  {
   ...
   {
    'url': "./imagenes/pantera-negra.jpg",
    'titulo': "La pantera negra",
    'descripcion': `La pantera negra es una variación negra (melanismo) de varias especies de grandes félidos, en especial del
   ...
   {
    'url': "./imagenes/jaguar.jpg",
    'titulo': "El leopardo",
    'descripcion': `El jaguar, yaguar o yaguareté (Panthera onca) es un carnívoro félido de la subfamilia de los Panterinos y
  ...
  },
  {
    ...
    'titulo': "El guepardo",
    'descripcion': `El guepardo o chita (Acinonyx jubatus)1​ es un miembro atípico de la familia de los félidos. Es el único
...
function escribirNoticia(url, titulo, descripcion){
  const template = `
    <div class="item">
    <img src=${url}>
    <h2>${titulo}</h2>
...
for (const noticia of noticias) {
  escribirNoticia(noticia['url'],noticia['titulo'],noticia['descripcion'])  
}